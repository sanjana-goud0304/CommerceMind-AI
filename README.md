...
🔗 https://commerce-mind-ai.vercel.app/

## Backend API (Render)

🔗 https://commercemind-ai.onrender.com

## API Documentation

🔗 https://commercemind-ai.onrender.com/docs
...
```bash
git clone https://github.com/sanjana-goud0304/CommerceMind-AI.git
cd CommerceMind-AI
```
